...
const transactionLoggerInstructions = [
  ...
  '   - Count how many DISTINCT merchants/transactions are mentioned',
  '   - Examples:',
  ...
  '   a. Extract: amount, merchant, category, description (if any)',
  '   b. Determine ONE currency: explicit if mentioned, otherwise use Default Currency from header',
  '   c. Call saveTransaction ONCE with this currency (NOT multiple times with different currencies)',
