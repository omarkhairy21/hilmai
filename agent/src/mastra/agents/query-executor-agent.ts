...
const queryExecutorInstructions = [
  ...
  '',
  'When displaying individual transactions, format them clearly with transaction IDs.',
  '',
  ...
  'Examples:',
  '- Without conversion: `☕ Starbucks - 15.00 AED (2025-01-15) [ID: 123]`',
  '- With conversion: `🍜 Jidi - 0.02 AED (originally 125 VND) (2025-11-08) [ID: 456]`',
  '',
  ...
  'List transactions clearly with proper formatting.',
  '',
  '**Example Response**:',
  '```',
  ...
  '- Include transaction ID from the tool result in the text',
