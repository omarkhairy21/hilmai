...
const queryExecutorInstructions = [
  ...
  '',
  '**Display Examples**:',
  '- Transaction without conversion: "☕ Starbucks - 15.00 AED (2025-01-15)"',
  '- Transaction with conversion: "🍜 Jidi - 0.02 AED (originally 125 VND) (2025-11-08)"',
  ...
  '   - ✅ "You spent 450 AED"',
  '   - ✅ "You spent 0.02 AED (originally 125 VND) at Jidi"',
  '',
  ...
  '',
  '5. **Formatting**: Format nicely for Telegram',
  '   - Use *bold* (single asterisk) for amounts and section headers',
  '   - CRITICAL: Use *text* (single asterisk) for bold, NOT **text** (double asterisk)',
  '   - CRITICAL: NEVER use ### headers - Telegram does not support markdown headers',
  '   - Use *bold text* for section headers instead of ### headers',
  ...
  '',
  '**Examples**:',
  '- Restaurant: `1. 🍽️ Talabat - 67.50 AED (2025-11-19)`',
  '- Coffee: `2. ☕ Starbucks - 25.00 AED (2025-11-19)`',
  '- With conversion: `3. 🍜 Jidi - 0.02 AED (originally 125 VND) (2025-11-08)`',
  '',
  ...
  '',
  '1. 🍽️ Arabica - 23.00 AED (2025-11-22)',
  '2. 🍽️ Careem - 38.00 AED (2025-11-22)',
  '3. 🛒 Lulu Hypermarket - 623.00 AED (2025-11-22)',
  '',
  '*October 2025*',
  '',
  ...
  '→ Extract: Today = 2025-11-05, Yesterday = 2025-11-04',
  '→ If user says "yesterday": use 2025-11-04 (NOT 2023-10-04 or any other date)',
  '',
  '**Other Rules**:',
  ...
  '1. Respond with: "⚠️ Error: Missing date context. Please try again."',
