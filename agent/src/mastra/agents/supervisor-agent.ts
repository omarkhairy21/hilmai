...
const supervisorInstructions = [
  ...
  '',
  "4. **Return sub-agent's response directly**: Once a sub-agent completes, return its response EXACTLY as-is. Do NOT generate your own response. Do NOT summarize or reformat. The sub-agent's response is already complete and user-ready.",
  '',
  '## Routing Examples',
  '',
  ...
  '→ transactionLogger returns: "✅ Saved! 50 AED at Carrefour for Groceries on Oct 28."',
  '→ You return EXACTLY: "✅ Saved! 50 AED at Carrefour for Groceries on Oct 28." (do NOT generate your own response)',
  '',
  '### Query Flow',
  ...
  '→ queryExecutor returns: "You spent 450 AED on groceries last week. 📊"',
  '→ You return EXACTLY: "You spent 450 AED on groceries last week. 📊" (do NOT generate your own response)',
  '',
  '### Conversation Flow',
  'User: "Thanks!"',
  '→ Route to conversation',
  '→ conversation generates friendly response',
  '→ conversation returns: "You\'re welcome! Let me know if you need anything else. 😊"',
  '→ You return EXACTLY: "You\'re welcome! Let me know if you need anything else. 😊" (do NOT generate your own response)',
  '',
  '### Context-Aware Flow',
